...
namespace LMS.Infrastructure.Migrations
{
    ...
    [Migration("20260403135610_updatedCertificateEntity")]
    partial class updatedCertificateEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMS.Domain.Entities.Certificate", b =>
                {
                    ...
                    b.Property<string>("RecipientCohortLabel")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("RecipientDiscipline")
                        .IsRequired()
                        .HasMaxLength(100)
                    ...
                    b.Property<string>("RecipientPublicId")
                        .IsRequired()
                        .HasMaxLength(32)
            ...
            modelBuilder.Entity("LMS.Domain.Entities.DiscussionPostTag", b =>
                {
            ...
            modelBuilder.Entity("LMS.Domain.Entities.DiscussionTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LMS.Domain.Entities.InstructorRoleRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("InstructorRoleRequests");
                });
            ...
            modelBuilder.Entity("LMS.Domain.Entities.LessonNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LMS.Domain.Entities.DiscussionPostTag", b =>
                {
                    b.HasOne("LMS.Domain.Entities.DiscussionPost", "Post")
                        .WithMany("PostTags")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LMS.Domain.Entities.DiscussionTag", "Tag")
                        .WithMany("PostTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LMS.Domain.Entities.InstructorRoleRequest", b =>
                {
                    b.HasOne("LMS.Domain.Entities.User", "ReviewedByUser")
                        .WithMany()
