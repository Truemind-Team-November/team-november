        ...
        <div className="flex-1 flex flex-col items-center justify-center min-h-[400px] text-center border border-dashed border-zinc-800 rounded-2xl">
          ...
          <p className="text-zinc-500 italic max-w-sm">
            ...
            <span className="text-xs mt-2 block">
              If you are an Instructor, please use the Admin Dashboard to manage
              teams.
            </span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="border border-slate-700 rounded-2xl p-6 bg-[#161f2c]/50 backdrop-blur-sm shadow-xl">
            <div className="flex items-start gap-4 mb-8">
              <div className="w-12 h-12 bg-blue-600/10 border border-blue-500/20 rounded-xl flex items-center justify-center text-2xl">
                🛡️
              </div>
              <div>
            ...
            <div className="space-y-6">
              {team.members?.map((member) => (
                <div key={member.id} className="flex items-center gap-4">
                  <div
                    className={`${getColor(member.id)} w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm shrink-0`}
                  >
                  ...
                  <div className="overflow-hidden">
                    ...
                    <p className="text-[11px] text-zinc-500 truncate uppercase tracking-wide">
                      {member.discipline || "Learner"}
                    </p>
                  </div>
                </div>
              ))}
