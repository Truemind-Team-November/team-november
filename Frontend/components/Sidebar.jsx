...
const Sidebar = ({ badges = {}, activeTab = "Dashboard" }) => {
  return (
    <aside
      id="sidebar-nav"
      className="flex flex-col items-start w-[20.26vw] min-w-[250px] border-r-[0.75px] border-[#7D7F82] h-screen sticky top-0 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']"
